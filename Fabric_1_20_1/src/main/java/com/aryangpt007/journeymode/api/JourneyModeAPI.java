...
public final class JourneyModeAPI {
    ...
    public static final Set<String> DENYLISTED_KEYS = Set.of("BlockEntityTag", "Items", "Inventory", "ChargedProjectiles");
    ...
    public static Set<String> collectAdditionalNormalizationKeys(net.minecraft.nbt.CompoundTag originalTag) {

 ...
 *
 * Unlike Forge 1.20.1's TeamData, key derivation here needs a RegistryAccess (Data Components,
 * not NBT, back the hybrid key - see JourneyDataAttachment.getItemKey), so depositItem/isUnlocked/
 * getCollectedCount/getProgress take a RegistryAccess parameter to match.
 */

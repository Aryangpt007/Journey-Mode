...
public class JourneyModeScreen extends ContainerScreen<JourneyModeMenu> {
    ...
    protected void renderBg(MatrixStack matrixStack, float partialTick, int mouseX, int mouseY) {
        ...
        if (teamName != null) {
            this.font.draw(matrixStack, "Team: " + teamName, x + DEPOSIT_TAB_X, y + TAB_Y_OFFSET - 10, 0xFFFFFF55);
        }
    ...
    private void renderStatsTab(MatrixStack matrixStack, int x, int y) {
        ...
        int lineY = y + 10;
        this.font.draw(matrixStack, "Unlocked: " + unlockedCount + " / " + totalResearchable, x + 8, lineY, 0x404040);
        lineY += 12;
        this.font.draw(matrixStack, "Complete: " + percent + "%", x + 8, lineY, 0x404040);
        lineY += 16;

        this.font.draw(matrixStack, "By mod:", x + 8, lineY, 0x606060);
        lineY += 11;
        ...
        for (java.util.Map.Entry<String, Integer> entry : perNamespaceTotal.entrySet()) {
            ...
            this.font.draw(matrixStack, namespace + ": " + nsUnlocked + "/" + nsTotal, x + 12, lineY, 0x404040);
            lineY += 10;
            rows++;
        }
        ...
        if (!data.getUnlockTimestamps().isEmpty()) {
            ...
            if (latestKey != null) {
                ...
                this.font.draw(matrixStack, "Latest: " + latestName, x + 8, y + 96, 0x606060);
            }
        }
    }

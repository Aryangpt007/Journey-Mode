...
public class TooltipHandler {
    ...
    private static net.minecraft.item.Item cachedThresholdItem = null;
    private static int cachedThresholdGeneration = -1;
    private static int cachedThreshold = 1;

    private static int thresholdFor(JourneyDataAttachment data, net.minecraft.item.Item item) {

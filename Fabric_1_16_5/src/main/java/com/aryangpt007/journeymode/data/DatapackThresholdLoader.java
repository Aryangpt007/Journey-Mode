...
public class DatapackThresholdLoader extends SimplePreparableReloadListener<Map<String, Integer>> implements IdentifiableResourceReloadListener {
    ...
    protected Map<String, Integer> prepare(ResourceManager resourceManager, ProfilerFiller profiler) {
        ...
        Collection<ResourceLocation> locations = resourceManager.listResources("journeymode/thresholds",
        ...
        for (ResourceLocation location : locations) {
            try (Resource resource = resourceManager.getResource(location);
                ...
                LOGGER.error("Failed to parse datapack threshold file " + location, e);
            }
        }
    ...
    public ResourceLocation getFabricId() {
        return new ResourceLocation("journeymode", "datapack_thresholds");
    }

...
public class JourneyModeCommand {
    ...
    private static int setJourneyMode(CommandSourceStack source, boolean enabled) {
        ...
        if (enabled) {
            source.sendSuccess(new TranslatableComponent("journeymode.command.enabled"), false);
        } else {
            source.sendSuccess(new TranslatableComponent("journeymode.command.disabled"), false);
        }
    ...
    private static int queryJourneyMode(CommandSourceStack source) {
        ...
        if (enabled) {
            source.sendSuccess(new TranslatableComponent("journeymode.command.status.enabled"), false);
        } else {
            source.sendSuccess(new TranslatableComponent("journeymode.command.status.disabled"), false);
        }
